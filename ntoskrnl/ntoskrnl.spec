...
@ stdcall -stub -version=0x600+ IoAllocateSfioStreamIdentifier(ptr long ptr ptr)
...
@ stdcall -stub -version=0x600+ IoFreeSfioStreamIdentifier(ptr ptr)
...
@ stdcall -stub -version=0x600+ IoGetSfioStreamIdentifier(ptr ptr)
...
@ stub -version=0x603+ FsRtlInsertReservedPerFileContext
@ stub -version=0x603+ FsRtlInsertReservedPerStreamContext
@ stub -version=0x603+ FsRtlLookupReservedPerFileContext
@ stub -version=0x603+ FsRtlLookupReservedPerStreamContext
@ stub -version=0x603+ FsRtlRemoveReservedPerFileContext
@ stub -version=0x603+ FsRtlRemoveReservedPerStreamContext
...
@ stub -version=0x603+ IoLoadCrashDumpDriver
...
@ stub -version=0x603+ ZwQuerySystemInformationEx