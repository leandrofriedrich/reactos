...
//plzstop(FIELD_OFFSET(BTRFS_SUPER_BLOCK, uuid) == 0x20);
//plzstop(FIELD_OFFSET(BTRFS_SUPER_BLOCK, sb_phys_addr) == 0x30);
//plzstop(FIELD_OFFSET(BTRFS_SUPER_BLOCK, magic) == 0x40);
