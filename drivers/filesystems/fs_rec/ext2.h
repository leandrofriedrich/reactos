...
//plzstop(FIELD_OFFSET(EXT2_SUPER_BLOCK, FreeInodesCount) == 0x10);
//plzstop(FIELD_OFFSET(EXT2_SUPER_BLOCK, BlocksPerGroup) == 0x20);
//plzstop(FIELD_OFFSET(EXT2_SUPER_BLOCK, WriteTime) == 0x30);
//plzstop(FIELD_OFFSET(EXT2_SUPER_BLOCK, LastCheck) == 0x40);
//plzstop(FIELD_OFFSET(EXT2_SUPER_BLOCK, DefResUid) == 0x50);
