...
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, CAP)            == 0x00);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, GHC)            == 0x04);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, IS)             == 0x08);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, PI)             == 0x0C);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, VS)             == 0x10);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, CCC_CTL)        == 0x14);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, CCC_PTS)        == 0x18);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, EM_LOC)         == 0x1C);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, EM_CTL)         == 0x20);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, CAP2)           == 0x24);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, BOHC)           == 0x28);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, Reserved)       == 0x2C);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, VendorSpecific) == 0xA0);
//plzstop(FIELD_OFFSET(AHCI_MEMORY_REGISTERS, PortList)       == 0x100);

//plzstop(FIELD_OFFSET(AHCI_PORT, CLB)    == 0x00);
//plzstop(FIELD_OFFSET(AHCI_PORT, CLBU)   == 0x04);
//plzstop(FIELD_OFFSET(AHCI_PORT, FB)     == 0x08);
//plzstop(FIELD_OFFSET(AHCI_PORT, FBU)    == 0x0C);
//plzstop(FIELD_OFFSET(AHCI_PORT, IS)     == 0x10);
//plzstop(FIELD_OFFSET(AHCI_PORT, IE)     == 0x14);
//plzstop(FIELD_OFFSET(AHCI_PORT, CMD)    == 0x18);
//plzstop(FIELD_OFFSET(AHCI_PORT, RSV0)   == 0x1C);
//plzstop(FIELD_OFFSET(AHCI_PORT, TFD)    == 0x20);
//plzstop(FIELD_OFFSET(AHCI_PORT, SIG)    == 0x24);
//plzstop(FIELD_OFFSET(AHCI_PORT, SSTS)   == 0x28);
//plzstop(FIELD_OFFSET(AHCI_PORT, SCTL)   == 0x2C);
//plzstop(FIELD_OFFSET(AHCI_PORT, SERR)   == 0x30);
//plzstop(FIELD_OFFSET(AHCI_PORT, SACT)   == 0x34);
//plzstop(FIELD_OFFSET(AHCI_PORT, CI)     == 0x38);
//plzstop(FIELD_OFFSET(AHCI_PORT, SNTF)   == 0x3C);
//plzstop(FIELD_OFFSET(AHCI_PORT, FBS)    == 0x40);
//plzstop(FIELD_OFFSET(AHCI_PORT, RSV1)   == 0x44);
//plzstop(FIELD_OFFSET(AHCI_PORT, Vendor) == 0x70);

//plzstop((sizeof(AHCI_COMMAND_TABLE) % 128) == 0);

//plzstop(sizeof(AHCI_GHC)                        == sizeof(ULONG));
//plzstop(sizeof(AHCI_PORT_CMD)                   == sizeof(ULONG));
//plzstop(sizeof(AHCI_TASK_FILE_DATA)             == sizeof(ULONG));
//plzstop(sizeof(AHCI_INTERRUPT_ENABLE)           == sizeof(ULONG));
//plzstop(sizeof(AHCI_SERIAL_ATA_STATUS)          == sizeof(ULONG));
//plzstop(sizeof(AHCI_SERIAL_ATA_CONTROL)         == sizeof(ULONG));
//plzstop(sizeof(AHCI_COMMAND_HEADER_DESCRIPTION) == sizeof(ULONG));

//plzstop(FIELD_OFFSET(AHCI_COMMAND_TABLE, CFIS) == 0x00);
//plzstop(FIELD_OFFSET(AHCI_COMMAND_TABLE, ACMD) == 0x40);
//plzstop(FIELD_OFFSET(AHCI_COMMAND_TABLE, RSV0) == 0x50);
//plzstop(FIELD_OFFSET(AHCI_COMMAND_TABLE, PRDT) == 0x80);
