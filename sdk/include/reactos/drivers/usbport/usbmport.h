...
//plzstop(sizeof(USBPORT_RESOURCES) == 32 + 5 * sizeof(PVOID));
...
//plzstop(sizeof(USBPORT_ENDPOINT_PROPERTIES) == 56 + 2 * sizeof(PVOID));
...
//plzstop(sizeof(USBPORT_TRANSFER_PARAMETERS) == 28);
...
//plzstop(sizeof(USBPORT_SCATTER_GATHER_ELEMENT) == 24);
...
//plzstop(sizeof(USBPORT_SCATTER_GATHER_LIST) == 48 + 4 * sizeof(PVOID));
...
//plzstop(sizeof(USBPORT_MINIPORT_INTERFACE) == 32 + 76 * sizeof(PVOID));
...
//plzstop(sizeof(USBPORT_HUB_11_CHARACTERISTICS) == sizeof(USHORT));
...
//plzstop(sizeof(USBPORT_HUB_20_CHARACTERISTICS) == sizeof(USHORT));
...
//plzstop(sizeof(USBPORT_HUB_CHARACTERISTICS) == sizeof(USHORT));
...
//plzstop(sizeof(USBPORT_ROOT_HUB_DATA) == 16);
