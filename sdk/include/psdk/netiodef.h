...
//plzstop(DL_ADDRESS_LENGTH_MAXIMUM >= sizeof(DL_EUI48));
...
//plzstop(ETH_LENGTH_OF_HEADER == sizeof(ETHERNET_HEADER));
//plzstop(ETH_LENGTH_OF_SNAP_HEADER == sizeof(SNAP_HEADER));
...
//plzstop(ETH_LENGTH_OF_VLAN_HEADER == sizeof(VLAN_TAG));
...
//plzstop((sizeof(TOKENRING_HEADER) + sizeof(SNAP_HEADER) + SOURCEROUTE_SIZE_MAXIMUM) < DL_HEADER_LENGTH_MAXIMUM);
...
//plzstop(sizeof(IPV4_OPTION_HEADER) == 2);
...
//plzstop(sizeof(IPV6_FRAGMENT_HEADER) == 8);
...
//plzstop(DL_ADDRESS_LENGTH_MAXIMUM >= DL_SIZEOF_IPV4_TUNNEL_ADDRESS);
//plzstop(DL_ADDRESS_LENGTH_MAXIMUM >= DL_SIZEOF_IPV6_TUNNEL_ADDRESS);
...
//plzstop(DL_ADDRESS_LENGTH_MAXIMUM >= sizeof(DL_TEREDO_ADDRESS));
