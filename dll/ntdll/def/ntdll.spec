...
;@ stdcall -stub -version=0x602+ _wcslwr_s()
;@ stdcall -stub -version=0x602+ _wcstoi64()
;@ stdcall -stub -version=0x602+ _wcsupr_s()
;@ stdcall -stub -version=0x602+ iswalnum()
;@ stdcall -stub -version=0x602+ iswascii()
;@ stdcall -stub -version=0x602+ iswgraph()
;@ stdcall -stub -version=0x602+ iswprint()
@ stdcall -stub -version=0x602+ qsort_s()
;@ stdcall -stub -version=0x602+ wcstok_s()

;Windows 8.1 stuff
@ stub -version=0x603+ KiUserInvertedFunctionTable
@ stub -version=0x603+ LdrSetImplicitPathOptions
@ stub -version=0x603+ NtCancelTimer2
@ stub -version=0x603+ NtCreateTimer2
@ stub -version=0x603+ NtGetCompleteWnfStateSubscription
@ stub -version=0x603+ NtSetTimer2
@ stub -version=0x603+ NtSetWnfProcessNotificationEvent
@ stub -version=0x603+ PssNtCaptureSnapshot
@ stub -version=0x603+ PssNtDuplicateSnapshot
@ stub -version=0x603+ PssNtFreeRemoteSnapshot
@ stub -version=0x603+ PssNtFreeSnapshot
@ stub -version=0x603+ PssNtFreeWalkMarker
@ stub -version=0x603+ PssNtQuerySnapshot
@ stub -version=0x603+ PssNtValidateDescriptor
@ stub -version=0x603+ PssNtWalkSnapshot
@ stub -version=0x603+ RtlAddProcessTrustLabelAce
@ stub -version=0x603+ RtlAllocateAndInitializeSidEx
@ stub -version=0x603+ RtlGetAppContainerParent
@ stub -version=0x603+ RtlGetAppContainerSidType
@ stub -version=0x603+ RtlIsParentOfChildAppContainer
@ stub -version=0x603+ RtlIsValidProcessTrustLabelSid
@ stub -version=0x603+ RtlQueryPackageIdentityEx
@ stub -version=0x603+ RtlQueryResourcePolicy
@ stub -version=0x603+ RtlSidDominatesForTrust
@ stub -version=0x603+ RtlStringFromGUIDEx
@ stub -version=0x603+ RtlTestProtectedAccess
@ stub -version=0x603+ RtlValidProcessProtection
@ stub -version=0x603+ TpCallbackSendAlpcMessageOnCompletion
@ stub -version=0x603+ TpCallbackSendPendingAlpcMessage
@ stub -version=0x603+ TpTrimPools
@ stub -version=0x603+ WinSqmStartSessionForPartner
@ stub -version=0x603+ ZwCancelTimer2
@ stub -version=0x603+ ZwCreateTimer2
@ stub -version=0x603+ ZwGetCompleteWnfStateSubscription
@ stub -version=0x603+ ZwSetTimer2
@ stub -version=0x603+ ZwSetWnfProcessNotificationEvent

;Windows 10 stuff 
@ stub -version=0xA00+ DbgUiConvertStateChangeStructureEx
@ stub -version=0xA00+ LdrFastFailInLoaderCallout
@ stub -version=0xA00+ NtAlpcImpersonateClientContainerOfPort
@ stub -version=0xA00+ NtCompareObjects
@ stub -version=0xA00+ NtCreatePartition
@ stub -version=0xA00+ NtGetCurrentProcessorNumberEx
@ stub -version=0xA00+ NtManagePartition
@ stub -version=0xA00+ NtOpenPartition
@ stub -version=0xA00+ NtRevertContainerImpersonation
@ stub -version=0xA00+ NtSetInformationSymbolicLink
@ stub -version=0xA00+ NtWow64IsProcessorFeaturePresent
@ stub -version=0xA00+ RtlCapabilityCheck
@ stub -version=0xA00+ RtlCheckSandboxedToken
@ stub -version=0xA00+ RtlConvertDeviceFamilyInfoToString
@ stub -version=0xA00+ RtlConvertSRWLockExclusiveToShared
@ stub -version=0xA00+ RtlDecodeRemotePointer
@ stub -version=0xA00+ RtlDeriveCapabilitySidsFromName
@ stub -version=0xA00+ RtlEncodeRemotePointer
@ stub -version=0xA00+ RtlEndStrongEnumerationHashTable
@ stub -version=0xA00+ RtlFindUnicodeSubstring
@ stub -version=0xA00+ RtlGetDeviceFamilyInfoEnum
@ stub -version=0xA00+ RtlGetInterruptTimePrecise
@ stub -version=0xA00+ RtlInitStringEx
@ stub -version=0xA00+ RtlInitStrongEnumerationHashTable
@ stub -version=0xA00+ RtlInitializeSidEx
@ stub -version=0xA00+ RtlIsMultiSessionSku
@ stub -version=0xA00+ RtlIsProcessorFeaturePresent
@ stub -version=0xA00+ RtlOsDeploymentState
@ stub -version=0xA00+ RtlQueryPackageClaims
@ stub -version=0xA00+ RtlQueryProtectedPolicy
@ stub -version=0xA00+ RtlSetProtectedPolicy
@ stub -version=0xA00+ RtlSetThreadSubProcessTag
@ stub -version=0xA00+ RtlStronglyEnumerateEntryHashTable
@ stub -version=0xA00+ RtlSwitchedVVI
@ stub -version=0xA00+ RtlWoW64GetCpuAreaInfo
@ stub -version=0xA00+ RtlWoW64GetCurrentCpuArea
@ stub -version=0xA00+ RtlWow64SuspendThreadEx
@ stub -version=0xA00+ RtlpGetDeviceFamilyInfoEnum
@ stub -version=0xA00+ TpSetPoolMaxThreadsSoftLimit
@ stub -version=0xA00+ TpSetPoolWorkerThreadIdleTimeout
@ stub -version=0xA00+ WinSqmStartSqmOptinListener
@ stub -version=0xA00+ ZwAlpcImpersonateClientContainerOfPort
@ stub -version=0xA00+ ZwCompareObjects
@ stub -version=0xA00+ ZwCreatePartition
@ stub -version=0xA00+ ZwGetCurrentProcessorNumberEx
@ stub -version=0xA00+ ZwManagePartition
@ stub -version=0xA00+ ZwOpenPartition
@ stub -version=0xA00+ ZwRevertContainerImpersonation
@ stub -version=0xA00+ ZwSetInformationSymbolicLink
@ stub -version=0xA00+ ZwWow64IsProcessorFeaturePresent
@ stub -version=0xA00+ atan2