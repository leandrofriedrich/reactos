...
@ cdecl -version=0x600+ _local_unwind4(ptr ptr long)
...
@ cdecl _onexit(ptr) # Declaring it as extern let us use the symbol from msvcrtex while having the __imp_ symbol defined in the import lib
